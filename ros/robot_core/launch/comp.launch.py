...
def generate_launch_description():
    ...
    b_rescue_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(b_rescue_pkg, 'launch', 'rescuebc.launch.py'))
    )
    ...
    return LaunchDescription([robot_core_launch, b_rescue_launch, t_rescue_launch])
